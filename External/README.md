...
9. Make changes into voting config described in wiki under [jip-error-fix](https://github.com/vlad333000/AR-Map-Voting/wiki/Setup#jip-error-fix) (Set `"runMethod"` to `"ScriptedRestart"`).
