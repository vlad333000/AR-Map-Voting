...
8. Make changes described in wiki under [jip-error-fix](https://github.com/vlad333000/AR-Map-Voting/wiki/Setup#jip-error-fix).
9. Save it as `config.template.json`.
